...
<style lang="scss">
	.sixth_nav {
		...
		#nav__checkbox:checked ~ ul.hamburger_options li {
			display: block;
		...
		#nav__checkbox:checked ~ label.nav__checkbox.close {
			display: block;
			animation-name: ease-in;
			animation-duration: 700ms;
			@keyframes ease-in {
		...
		#nav__checkbox:checked ~ label.right_nav.menu {
			display: none;
			animation-name: ease-in;
			animation-duration: 700ms;
			@keyframes ease-in {
